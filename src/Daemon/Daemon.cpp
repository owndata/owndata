...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    // For showing only needed options
    po::options_description help_options("Command line options");

    command_line::add_arg(help_options, command_line::arg_help);
    command_line::add_arg(help_options, command_line::arg_version);
    command_line::add_arg(help_options, arg_os_version);
    command_line::add_arg(help_options, command_line::arg_data_dir, Tools::getDefaultDataDirectory());
    command_line::add_arg(help_options, arg_config_file);
    command_line::add_arg(help_options, arg_log_file);
    command_line::add_arg(help_options, arg_log_level);
    command_line::add_arg(help_options, arg_console);
    command_line::add_arg(help_options, arg_set_fee_address);
    command_line::add_arg(help_options, arg_testnet_on);
    command_line::add_arg(help_options, arg_enable_cors);
    command_line::add_arg(help_options, arg_blockexplorer_on);

    RpcServerConfig::initOptions(help_options);
    NetNodeConfig::initOptionsForHelp(help_options);
    DataBaseConfig::initOptions(help_options);
